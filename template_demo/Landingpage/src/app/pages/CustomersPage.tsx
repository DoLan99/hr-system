...
const STORIES = [
  {
    ...
    industryColor: "#FFF3EE",
    industryText: "#CC4A10",
    result: "Giảm 3 buổi họp/tuần",
    resultDesc:
      "Toàn bộ cập nhật tiến độ chuyển lên jobihome — team lead không cần họp daily nữa.",
    quote:
      "jobihome giúp chúng tôi biết ai đang làm gì mà không cần hỏi. Tiết kiệm cả tiếng mỗi ngày.",
    name: "Minh Tuấn",
    title: "CTO",
    avatar: "MT",
    avatarBg: BLUE,
  ...
  },
  {
    ...
    industryColor: "#F3F0FF",
    industryText: "#5B21B6",
    result: "Tính lương tự động 100%",
    resultDesc:
      "Từ 2 ngày làm thủ công trong Excel xuống còn 20 phút — kế toán dành thời gian cho việc khác.",
    quote:
      "Trước đây mỗi tháng tôi mất 2 ngày tính lương. Bây giờ jobihome làm hết, tôi chỉ ký duyệt.",
    name: "Ngọc Kim",
    title: "Kế toán trưởng",
    avatar: "NK",
    avatarBg: "#7C3AED",
    metrics: [
      { value: "2 ngày", label: "→ 20 phút" },
      { value: "0 lỗi", label: "tính lương/tháng" },
    ],
  },
  {
    initials: "BV",
    ...
    industryColor: "#ECFDF5",
    industryText: "#065F46",
    result: "Onboard nhân viên mới trong 1 ngày",
    resultDesc:
      "Workflow tự động gửi checklist, phân quyền, mời workspace — HR không cần làm thủ công từng bước.",
    quote:
      "Nhân viên mới ngày đầu đã có đủ tool, task và quyền truy cập. Không ai phải hỏi lại nữa.",
    name: "Đức Hiệp",
    title: "Head of People",
    avatar: "DH",
    avatarBg: GREEN,
    metrics: [
      { value: "1 ngày", label: "onboarding hoàn chỉnh" },
      { value: "5×", label: "nhanh hơn trước" },
    ],
  },
]

const LOGOS = [
  { name: "Loship",       color: "#FF6B35" },
  { name: "Teko",         color: "#7C3AED" },
  { name: "Base.vn",      color: GREEN     },
  { name: "MoMo",         color: "#A21CAF" },
  { name: "Vnpay",        color: "#1D4ED8" },
  { name: "Ahamove",      color: "#D97706" },
]
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="pt-20 pb-16 text-center px-6">
        ...
        <h1 className="text-[38px] lg:text-[48px] font-extrabold text-gray-900 tracking-tight leading-[1.12] mb-4">
          Khách hàng của{" "}
          <span style={{ color: BLUE }}>jobihome.vn</span>
        </h1>
        <p className="text-[16px] text-gray-400 max-w-[480px] mx-auto leading-relaxed">
          Các startup và doanh nghiệp Việt đã thay đổi cách quản lý team
          như thế nào — bằng số liệu thực tế.
        </p>
      </section>
      ...
      <section className="max-w-[1060px] mx-auto px-6 pb-28">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {STORIES.map((s) => (
            <article
              key={s.company}
              className="group flex flex-col rounded-2xl bg-white transition-all duration-300 cursor-pointer"
              style={{
                border: "1px solid #E5E7EB",
                boxShadow: "0 2px 8px rgba(0,0,0,0.04)",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = `0 16px 48px rgba(59,91,219,0.12), 0 4px 16px rgba(0,0,0,0.06)`
            ...
            >
              ...
              <div
                ...
                style={{ background: `linear-gradient(90deg, ${s.logoColor}, ${s.logoColor}99)` }}
              />
              ...
              <div className="p-7 flex flex-col flex-1">
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div
                      className="w-11 h-11 rounded-xl flex items-center justify-center text-white font-black text-[14px] flex-shrink-0"
                    ...
                    <div>
                      ...
                      <span
                        className="inline-block mt-1 text-[10.5px] font-semibold px-2.5 py-0.5 rounded-full"
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {s.metrics.map((m) => (
                    ...
                    >
                      <p className="text-[18px] font-extrabold text-gray-900 leading-none mb-0.5">
                        {m.value}
                      </p>
                ...
                <div className="flex-1 mb-6">
                  ...
                  <p className="text-[13.5px] text-gray-600 leading-[1.75] italic">
                    "{s.quote}"
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between pt-5 border-t border-gray-100">
                  ...
                  <a
                    href="#"
                    className="flex items-center gap-1 text-[12.5px] font-semibold transition-all group-hover:gap-2"
                    style={{ color: BLUE }}
                  >
        ...
        {/* ── Bottom CTA ── */}
        <div
          className="mt-16 rounded-2xl px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left"
        ...
        >
          <div>
            ...
            <p className="text-[13.5px] text-gray-400">
              Tham gia 120+ startup Việt đang dùng jobihome mỗi ngày.
            </p>
          </div>
