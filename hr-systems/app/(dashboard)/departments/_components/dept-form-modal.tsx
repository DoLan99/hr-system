        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 space-y-3.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="col-span-2">
              <label className="block text-[12px] font-medium text-slate-700 mb-1.5">Tên phòng ban *</label>
              <input value={form.name} onChange={e => set("name", e.target.value)} required
                placeholder="VD: Phòng Phát triển" className="form-input" />
            </div>
            <div>
              <label className="block text-[12px] font-medium text-slate-700 mb-1.5">Mã (Code)</label>
          ...
          <div>
            <label className="block text-[12px] font-medium text-slate-700 mb-1.5">Trưởng phòng</label>
