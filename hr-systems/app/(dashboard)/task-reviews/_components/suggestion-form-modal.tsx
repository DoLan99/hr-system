      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-xl">
        ...
        <div className="p-5 space-y-3.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-xs text-slate-600 font-medium">Estimate (phút) <span className="text-red-500">*</span></label>
              <input
                type="number"
                min={1}
          ...
          <div>
            <label className="text-xs text-slate-600 font-medium">Mô tả công việc <span className="text-red-500">*</span></label>
            <textarea
          ...
          <div>
            <label className="text-xs text-slate-600 font-medium">Video minh chứng (link) <span className="text-red-500">*</span></label>
            <input
              type="url"
          ...
          <div>
            <label className="text-xs text-slate-600 font-medium">Lý do đề xuất <span className="text-red-500">*</span></label>
            <textarea
